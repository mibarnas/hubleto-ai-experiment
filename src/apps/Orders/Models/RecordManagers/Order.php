...
namespace Hubleto\App\Custom\Orders\Models\RecordManagers;
...
class Order extends \Hubleto\Erp\RecordManager
{
  ...
  public function OWNER(): BelongsTo { return $this->belongsTo(User::class, 'id_owner', 'id'); }
  public function MANAGER(): BelongsTo { return $this->belongsTo(User::class, 'id_manager', 'id'); }
