 ...
 */
class Training_0002 extends Migration
{

  public function upgradeSchema(): void
  {
    $this->db->execute("alter table `trainings` add column `shared_with` text NULL default NULL;");
  }

  public function downgradeSchema(): void
  {
    $this->db->execute("alter table `trainings` drop column `shared_with`;");
  }
