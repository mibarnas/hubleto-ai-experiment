...
class TrainingOrder_0001 extends Migration
{
...
create table `training_orders` (
 ...
 `number_of_applicants` int(255) ,
 `total_price` decimal(14, 2) ,
 `id_currency` int(8) NULL default NULL,
 `date_ordered` date ,
 `date_paid` date ,
 `applicants_xlsx` varchar(255) ,
 `note` text ,
 ...
 index `number_of_applicants` (`number_of_applicants`),
...
set foreign_key_checks = 1;");
  ...
  public function upgradeForeignKeys(): void
  {
    $this->db->execute("ALTER TABLE `training_orders`
          ...
          ON DELETE RESTRICT
          ON UPDATE RESTRICT; ALTER TABLE `training_orders`
          ADD CONSTRAINT `fk_5b235a4d171b108ea90259d972b95c34`
  ...
  public function downgradeForeignKeys(): void
  {
    $this->db->execute("ALTER TABLE `training_orders`
          ...
          DROP FOREIGN KEY `fk_5b235a4d171b108ea90259d972b95c34`; ALTER TABLE `training_orders`
